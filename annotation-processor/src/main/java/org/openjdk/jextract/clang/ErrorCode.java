...
public enum ErrorCode {
    Success(Index_h.CXError_Success()),
    Failure(Index_h.CXError_Failure()),
    Crashed(Index_h.CXError_Crashed()),
    InvalidArguments(Index_h.CXError_InvalidArguments()),
    ASTReadError(Index_h.CXError_ASTReadError());
