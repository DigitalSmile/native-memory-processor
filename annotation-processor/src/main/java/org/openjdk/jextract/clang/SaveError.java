...
public enum SaveError {
    None(Index_h.CXSaveError_None()),
    Unknown(Index_h.CXSaveError_Unknown()),
    TranslationErrors(Index_h.CXSaveError_TranslationErrors()),
    InvalidTU(Index_h.CXSaveError_InvalidTU());
