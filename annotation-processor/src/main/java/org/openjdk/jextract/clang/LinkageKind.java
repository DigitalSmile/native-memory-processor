...
public enum LinkageKind {
    Invalid(Index_h.CXLinkage_Invalid()),
    NoLinkage(Index_h.CXLinkage_NoLinkage()),
    Internal(Index_h.CXLinkage_Internal()),
    UniqueExternal(Index_h.CXLinkage_UniqueExternal()),
    External(Index_h.CXLinkage_External());
